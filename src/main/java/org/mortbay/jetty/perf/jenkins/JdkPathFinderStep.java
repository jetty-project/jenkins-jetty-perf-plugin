...
public class JdkPathFinderStep extends Step
{
    ...
    //@Override
    public void performttt(Run<?, ?> run, FilePath workspace, Launcher launcher, TaskListener listener) throws InterruptedException, IOException {
        ...
        for (String nodeName : nodes)
        {
            ...
            for (String jdkName : jdkNames)
            {
                ...
                listener.getLogger().println("node " + nodeName + ", jdkName:'" + jdkName + "' found jdk:" + jdk + "," + jdk.getClass());
